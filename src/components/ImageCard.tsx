...
function ImageCard({
  ...
  return (
    <motion.div
      className="relative w-[25vw] min-w-[280px] max-w-[400px]"
    ...
    >
      <Link to={`/gallery/${id}`}>
        <div className="relative mb-6 aspect-[3/4] overflow-hidden group">
          <motion.img
            src={image}
            alt={title}
      ...
      >
        <p className="text-xs uppercase tracking-wider">{character}</p>
